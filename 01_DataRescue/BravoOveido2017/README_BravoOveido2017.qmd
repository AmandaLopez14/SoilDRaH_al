---
title: "Data Rescue: Bravo-Oveido 2017"
format:
  html:
    toc: true
...
bibliography:
  - BravoOveido_Methods.bib #contains the citations in the methods section
  - BravoOveido.bib #contains citation for the data source, generally a single citation of the primary paper
authors: #author scheme from https://quarto.org/docs/journals/authors.html
  - id: AmandaLopez14 #use the github name as an id
    name:
      given: Amanda
      family: Lopez
    orcid: #idk what this is
    affiliation:
      - ref: uf-ees
  ...
  - id: laylakalandjian #use the github name as an id
    ...
    role: #TODO define these roles and add reference
      ...
      - standardization: lead #review
      - curation: lead #review
  - id: # i think its brandon #use the github name as an id
    name:
      given: 
      family: 
    orcid: #idk what this is
...
timelog:
  - activity: 
      description: Methods transcription
      ...
      duration: P10M
  - activity: 
      description: Secondary methods transcription
      ...
      duration: P45M
  - activity: 
      description: Table 1 transcribed
      who: AmandaLopez14 #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-04
      #start: YYYY-MM-DD THH:MM
      ...
      duration: P45M
  - activity: 
      description: Table 2 trasncribed
      who: AmandaLopez14 #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-04
      #start: YYYY-MM-DD THH:MM
      ...
      duration: P45M
  - activity: 
      description: cross checks of methods and tables
      who: laylakalandjian #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-04
      #start: YYYY-MM-DD THH:MM
      ...
      duration: P30M
  - activity: 
      description: readme updated, .bib and methods.bib created
      who: AmandaLopez14 #github username
      #when you started and ended, can be just a year or down to the minute
      end: 2026-09-09 13:14
      #start: YYYY-MM-DD THH:MM
      #alternatively duration can be combined with a being/end
      duration: P30M
...
BravoOveido2017_Methods.md <- "AuthorYYYY_Methods.md"
BravoOveido2017_Table1.csv <- 'AuthorYYYY_TableN.csv'
BravoOveido2017_Table2.csv
BravoOveido2017_Figure1.csv # figureM.file <- 'AuthorYYYY_FigureM.csv' 

# Bibliography files
BravoOveido2017.bib <- 'AuthorYYYY.bib'
BravoOveido2017_Methods.bib <- 'AuthorYYYY_Methods.bib'
...
Bravo-Oviedo, Andrés & Ruiz-Peinado, Ricardo & Onrubia, Raquel & Rio, Miren. (2017). Thinning alters the early-decomposition rate and nutrient immobilization-release pattern of foliar litter in Mediterranean oak-pine mixed stands. Forest Ecology and Management. 391. 309-320. 10.1016/j.foreco.2017.02.032. 

For the discussion of this data rescue see the Github issue: https://github.com/ktoddbrown/SoilDRaH/issues/#.

This paper looks at the effects of forest thinning on early-stage foliar decomposition rate and nutient immobilization-release pattern in a mixed Quercus pyreniaca-Pinus pinaster forest in the western Meditterenean basin. Decay rates and dry mass remaining were examined along with concentrations of elements like C, N, P, Ca, Mg, and K before and after an incubation period of two years. Two thinning treatments were tested along with a control group, labeled labeled Light Thinning (HT), Heavy Thinning (LT) and Control (CT). Data was collected and analyzed with a linear mixed model analysis, finding that thinning reduced the decay rate of forest litter as well as concentrations of Nitrogen and Phosphorus.
...
- Table 
  1) Initial concentration of elements analyzed two years after thinning for different litter types and treatments, including C:N ratio.
  2) Decay rates for various litter types with different treatments.
  3) Linear mixed effect model for element concentration during 2-year litter decomposition.
  4) Linear mixed effect model for release-immobilization pattern during 2-year litter decomposition including Carbon, Nitrogen, and Phosphorus.
  5) Pairwise difference least mean comparison by litter type and treatment in C, N, and P.

- Figure 
  1)  Remaining dry mass % of litter after two years of decomposition.
  2) Concentration dynamics after two years of decomposition including C, N, P, etc. concentrations.
  3a) C, N, and P stock dynamics after two years of decomposition as % vs time since incubation.
  3b) Mg, Ca, and K stock dynamics after two years of decomposition as % vs time since incubation.
...
### Main Variables of Interest
  - Location: Found in the Experimental area and layout subheading of the Material and Methods section; located in Montes de Toledo, central Spain, (39°31′N, 4°16′40″W)
  - Duration: Found in the Experimental area and layout subheading of the Material and Methods section; May 2011- February 2013
  - Mass Loss: Decay rate can be found in Table 2, Remaining dry mass can be found in Figure 1 
  - Solar Exposure: Solar exposure not explicitly stated, but canopy reduction mentioned in the Experimental area and layout section of the Material and methods section. 

### Other Relevant Variables:
  - Litter species: Found in experimental area and layout subheading of the material and methods section
  - Litter Chemical Composition: Found in Table 1
  - Microsite data:  Found in the Experimental area and layout subheading of the Material and Methods section
  - Land use: Mixed forest stand, previously used as an experimental site for forced thinning; Mentioned in the Experimental area and layout subheading of the Material and Methods section
  - Litterbag method: Stated in the Experimental area and layout subheading of the Material and Methods section but bag area and mesh size not included
  - Ecosystem Age:  Found in the Experimental area and layout subheading of the Material and Methods section; >50 years.

## Files

<!--- Include a brief explaination to all the files in the folder--->

These files are in the BravoOveido2017 data rescue.

- [Readme](README_BravoOveido2017.qmd)
  + This is the primary file that documents the transcriptions and decision made during data rescue.
- [BravoOveido2017.bib](BravoOveido2017.bib)
  + citation for article transcribed
- [BravoOveido2017_Methods.bib](BravoOveido2017_Methods.bib)
  + citations for the methods section of the article
- [BravoOveido2017_Methods.md](BravoOveido2017_Methods.md)
  + methods transcribed from primary article
- [BravoOveido2017_Table1.csv](BravoOveido2017_Table1.csv)
  + table 1 from primary article 
- [BravoOveido2017_Table2.csv](BravoOveido2017_Table2.csv)
  + table 2 from primary article
- [BravoOveido2017_Figure1.csv](BravoOveido2017_Figure1.csv)
- [temp/](temp/)
...
<!--- somehow i do not have a temp folder. i know that Layla cross-checked everything???--->
...
+ Lead
  ...
  - [x] Create a copy of template folder and rename it to BravoOveido2017
...
+ Do
  ...
  - [ ] Extract points from Figure1 and export it to csv
...
read_csv(file = BravoOveido2017_Table1.csv, #read in the specific file
         skip = 1, #skip the first line with the caption
         #read everything as a character, don't worry about formatting yet
         col_types = cols(.default = col_character())) |>
  kable(caption = read_csv(file = BravoOveido2017_Table1.csv, #read in that file again but...
...
data.lvl0.ls <- list(
  ...
  citation = list(
    ...
    primary = read.bib(file = BravoOveido2017.bib), 
    #Citations for all referenced articles
    methods = read.bib(file = BravoOveido2017_Methods.bib)
  ),
  #Read in the text transcription of the article's methods section
  method = read_lines(file = BravoOveido2017_Methods.md),
  ...
  data = list(
    Table1 = list(
      ...
      #...the first row.
      caption = read_csv(file = BravoOveido2017_Table1.csv,
                         col_types = cols(.default = col_character()),
      ...
      primary = read_csv(file = BravoOveido2017_Table1.csv,
                         col_types = cols(.default = col_character()),
                         skip = 1)
    ) #End 'Table1' element
    ...
    Table2 = list(
      #Read the caption as a text string. Captions are the first cell on 
      #...the first row.
      caption = read_csv(file = BravoOveido2017_Table2.csv,
                         col_types = cols(.default = col_character()),
                         n_max = 1, col_names = FALSE)$X1[1],
      #Read in all the data, skipping the first row with the caption and read
      #...in the table as character. This element is a tibble (data.frame).
      primary = read_csv(file = BravoOveido2017_Table2.csv,
                         col_types = cols(.default = col_character()),
                         skip = 1)
    ) #End 'Table2' element
